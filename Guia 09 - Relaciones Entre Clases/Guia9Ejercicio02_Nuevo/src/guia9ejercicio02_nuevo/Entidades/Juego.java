...
public class Juego {
    ...
    public void ronda(){
        ...
        for (int i = 0; i < jugadores.size(); i++) {
            ...
            System.out.println("Apuntese en la cabeza y dispare!");
            if(jugadores.get(i).disparo(r)){
               
                System.out.println("Usted ha sido liquidado!!");
               ...
               // System.out.println("posicion de la municion: " + r.getPosicionAgua());//ESTO DEBERIA BORRARSE
                ...
                System.out.println("Usted se ha salvado.. Ahora vamos al siguiente jugador");
               // System.out.println("posicion actual: " + r.getPosicionActual());//ESTO DEBERIA BORRARSE
               // System.out.println("posicion de la municion: " + r.getPosicionAgua());//ESTO DEBERIA BORRARSE
            }
